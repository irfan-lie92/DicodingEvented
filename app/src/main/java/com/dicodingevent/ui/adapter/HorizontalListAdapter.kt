package com.dicodingevent.ui.adapter
...
import com.dicodingevent.databinding.ItemHorizontalBinding
...
class HorizontalListAdapter(
    ...
    inner class MyViewHolder(private val binding: ItemHorizontalBinding) :
